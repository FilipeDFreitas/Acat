...
namespace ACAT
{
    public partial class Principal : Form
    {
        ...
        bool menu_desenvolvimento = true;
        ...
        private void tabela_a_MouseMove(object sender, EventArgs e)
        {
        ...
        private void volume_a_MouseMove(object sender, MouseEventArgs e)
        {
            if (menu_volume == false)
            {
                area_b.Visible = false;
        ...
        private void bhaskara_a_MouseMove(object sender, MouseEventArgs e)
        {
            if (menu_bhaskara == false)
            {
                area_b.Visible = false;
        ...
        private void tabela_a_MouseMove(object sender, MouseEventArgs e)
        {
            if (menu_tabela == false)
            {
                tabela_a.Visible = false;
        ...
        private void desenvolvimento0_MouseMove(object sender, MouseEventArgs e)
        {
            if (menu_desenvolvimento == false)
            {
                desenvolvimento0.Visible = false;
                Desenvolvimento1.Visible = true;
            }
        ...
        private void triangulo_a_MouseMove(object sender, MouseEventArgs e)
        {
            if (menu_triangulo == false)
            {
                area_b.Visible = false;
        ...
        private void area_c_Click(object sender, EventArgs e)
        {
